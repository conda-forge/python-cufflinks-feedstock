About python-cufflinks-feedstock
================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/python-cufflinks-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4851&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/python-cufflinks-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `cufflinks-py, python-cufflinks` can be installed with `conda`:
...
```
mamba install cufflinks-py python-cufflinks
```

It is possible to list all of the versions of `cufflinks-py` available on your platform with `conda`:
...
```
mamba search cufflinks-py --channel conda-forge
```
...
mamba repoquery search cufflinks-py --channel conda-forge

# List packages depending on `cufflinks-py`:
mamba repoquery whoneeds cufflinks-py --channel conda-forge

# List dependencies of `cufflinks-py`:
mamba repoquery depends cufflinks-py --channel conda-forge
```
